...
typedef float sha_rnn_rnn1_input_t[SHARNN_HIDD_DIM0];
typedef float sha_rnn_fc_input_t[SHARNN_HIDD_DIM1];
typedef float sha_rnn_output_t[SHARNN_OUTPUT_DIM];
